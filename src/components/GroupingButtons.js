    ...
    return (
        <div className="buttonsArrangement">
            {calculatorButtons.map((eachButton, i) =>
                <Button key={i} value={eachButton.value} type={eachButton.type} text={eachButton.text} className={eachButton.className} text={eachButton.text} onClick={onClick}></Button>)}
        </div>
    );
}
